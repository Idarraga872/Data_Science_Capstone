...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site].groupby('class',as_index=False)['class'].count().reset_index()
        fig = px.pie(filtered_df, values='class', names='class', title='Pie Chart')
        return fig
